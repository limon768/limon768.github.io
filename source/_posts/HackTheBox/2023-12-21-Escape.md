...
machine_author:
  ...
  name: Geiseric
tags: [Escape, Bruteforce, leak, MSSQL, xp_cmdshell, Responder, xp_dirtree, NTLM, NTLMv2, WinRM, Evil-WinRM, BAK, ADCS, Certify, ESC1, Rubeus, smb, Hashcat, Windows, OSCP, Writeup, Nmap, smbclient, mssqlclient.py, GetNPUsers.py, GetUserSPNs.py, ASREPRoasting, Kerberoast, OpenSSL]
