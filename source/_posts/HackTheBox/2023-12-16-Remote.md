...
machine_author:
  ...
  name: mrb3n
tags: [Remote, Umbraco CMS, NFS, FTP, TeamViewer, RCE, Nishang, PowerShell, CVE-2019-18988, Windows, Privilege Escalation, WinRM, CrackStation, ExploitDB, Exploitation, Enumeration, Reverse Shell, Credential Dumping, Anonymous, Decrypt, CME, OSCP, Writeup, Nmap, Dirsearch, PsExec, Password Reuse, reg]
