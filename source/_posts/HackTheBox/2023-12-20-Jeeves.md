...
machine_author:
  ...
  name: mrb3n
tags: [Jeeves, Jenkins, enum4linux-ng, Bruteforce, CTF, datastream, smb, FileTransfer, PassTheHash, KeePass, kdbx, John the Ripper, Hashcat, CME, Windows, OSCP, Writeup, Enumeration, Port Scanning, Dirsearch, Reverse Shell, Alternate Data Streams, Privilege Escalation, NTLM Hash, Exploitation, Nmap, Netcat, KeePassXC, keepass2john, Impacket, PsExec, PowerShell]
