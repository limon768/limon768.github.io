...
machine_author:
  ...
  name: L4mpje
tags: [Bastion, SMB, Anonymous, smbclient, mRemoteNG, SAM, mremoteng-decrypt, CrackMapExec, VHD, secretsdump.py, Encrypted Passwords, Credentials Extraction, Windows, OSCP, Writeup, Nmap, guestmount, mount, SSH, CrackStation, Password Cracking, Privilege Escalation, Secrets Dumping]
