...
machine_author:
  ...
  name: ch4p
tags: [Shellshock, Beep, LFI, RCE, File Upload, Webmin, FreePBX, Elastix, SIP, svmap, svwar, Gobuster, Apache, Elastica, Webshell, Reverse Shell, Web, SSH, Privilege Escalation, Remote Code Execution, OSCP, Hackthebox, Writeup, Nmap, curl]
