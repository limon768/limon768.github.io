...
machine_author:
  ...
  name: ch4p
tags: [OS Command Injection, cronos, PHP, Web, DNS, Hackthebox, Writeup, SQL Injection, sqlmap, Reverse Shell, Subdomain Brute-Forcing, Cronjob, LinPEAS, Apache, URL Encoding, Privilege Escalation, Linux, OSCP, Nmap, Directory Brute-Forcing]
