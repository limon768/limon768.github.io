...
machine_author:
  ...
  name: TryHackMe
tags: [Skynet, TryHackMe, Writeup, OSCP, AutoRecon, Feroxbuster, smbmap, SquirrelMail, Python, Netcat, LinPEAS, tar, Brute Force, Privilege Escalation, Reverse Shell, Anonymous Share, Local File Inclusion, Remote File Inclusion, POP3, IMAP, Bash]
