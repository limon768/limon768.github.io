...
tags: [Lock, Gitea, access token, repository, reverse shell, privilege escalation, mRemoteNG, mRemoteNG decryptor, PDF24, MSI installer, Windows, shell access, CI/CD integration, Git, msfvenom, curl, SetOpLock, msiexec]
title: Lock - Vulnlab
---
