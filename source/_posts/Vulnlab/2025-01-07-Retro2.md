...
tags: [Retro2, Zerologon, NoPac, SMB, null session, password cracking, John the Ripper, .accdb, Windows shares, Impacket, secretsdump.py, Active Directory, LDAP, Kerberos, privilege escalation, domain administrator, credential dumping, Nmap, NetExec, smbclient]
