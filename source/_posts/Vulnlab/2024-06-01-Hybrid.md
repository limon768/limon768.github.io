...
tags: [Hybrid, VulnLab, chain, ADCS, Certipy, NFS, Roundcube, SUID, no-root-squash, Writeup, Nmap, Markasjunk, KeePass, BloodHound, ESC1, Impacket, psexec.py, KeyTabExtract, Reverse Shell, Privilege Escalation]
