...
tags: [Trusted, Enumeration, Nmap, Directory Brute-forcing, LFI, PHP Wrapper, MySQL Injection, RCE, Webshell, Reverse Shell, Privilege Escalation, Credential Dumping, Mimikatz, Kerberos, Trust Attack, Impacket, Encrypted Files, RUNasCs, Dirsearch, Responder, MySQL, CrackStation, Nishang, secretsdump.py, ticketer.py, psexec.py, Evil-WinRM]
