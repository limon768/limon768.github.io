...
tags: [Lustrous, Vulnlab, ASREPRoast, Hashcat, Kerberoast, PSCredential Decryption, BloodHound, Silver Ticket, Mimikatz, Backup Operators, reg.py, DCSync, Impacket, Active Directory, Privilege Escalation, Kerberos, HTTP Service Ticket, Internal Web Application, SID Enumeration, RDP Access, Defender Bypass, Remote Registry Dump, Machine Account Hash, Windows, Medium, FTP, GetNPUsers.py, PowerShell, BackupOperatorToDA, secretsdump.py, Pass-the-Ticket]
