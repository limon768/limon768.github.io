...
tags: [Retro, SMB, null session, RID brute forcing, password guessing, simple passwords, Windows shares, Pre-Windows 2000 Computers, credential change, Impacket, ESC1, Active Directory Certificate Services, Certipy, Kerberos, TGT request, Nmap, NetExec, smbclient, wmiexec.py]
title: Retro - Vulnlab
---
