...
tags: [Nmap, SMB, LDAP, SeBackupPrivilege, Diskshadow, Secretsdump, Brute Force, Password Change, Shadow Copy, Robocopy, smbpasswd, VulnLab, Baby, NetExec, ldapsearch, reg.exe, NTDS.dit]
