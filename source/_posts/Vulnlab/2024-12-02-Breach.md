...
tags: [DC, Breach, MSSQL, SMB, NTLMv2, Active Directory, Kerberos, Silver Ticket, Privilege Escalation, Enumeration, Credential Theft, Hashcat, John the Ripper, Reverse Shell, Hoaxshell, SeImpersonatePrivilege, getPAC, ticketer.py, Lateral Movement, Post-Exploitation, Medium Difficulty, Nmap, NetExec, GetUserSPNs.py, Kerberoasting, mssqlclient.py, GodPotato, Shortcut File Attack]
