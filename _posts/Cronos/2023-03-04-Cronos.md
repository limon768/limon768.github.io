...
description: Cronos is a medium Linux machine that focuses mainly on different vectors for enumeration and also emphasises the risks associated with adding world-writable files to the root crontab. This machine also includes an introductory-level SQL injection vulnerability
image: https://photos.squarezero.dev/file/abir-images/Cronos/logo.png
---
